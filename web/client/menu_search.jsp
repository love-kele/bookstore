...
<div id="divmenu">
		...
		<a href="${pageContext.request.contextPath}/searchall?page=1" style="color:#FFFF00">全部商品目录</a>
		
</div>
<div id="divsearch">
<form action="${pageContext.request.contextPath}/searchByName" id="searchform">
