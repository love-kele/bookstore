...
<body class="main">
	...
	<!-- 3.网上书城用户注册  start -->
	<div id="divcontent">
		<form  method="post"  action="${pageContext.request.contextPath}/register" id="registerid">
						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width: 40%">
									...
									id="email" name="email" onmouseout="checkemail()"/>
...
<%--<script>--%>
	<%--$("#registerid").submit(function () {--%>

        <%--$.ajax({--%>
            <%--url:"${pageContext.request.contextPath}/register",--%>
            <%--type:"POST",--%>
            <%--dataType:"json",--%>
            <%--data:{ user : $("#registerid").serialize()},--%>
            <%--success:function () {--%>
                <%--location.href="${pageContext.request.contextPath}/client/registersuccess.jsp"--%>
            <%--}--%>
