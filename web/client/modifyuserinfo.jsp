							...
							<td>
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td><input type="password" class="textinput" name="password" value="${user.password}"/></td>
										<td><font color="#999999">密码设置至少6位，请区分大小写</font></td>
									</tr>
									<tr>
										<td style="text-align:right">重复密码：</td>
										<td><input type="password" class="textinput" value="${user.password}"/></td>
										<td>&nbsp;</td>
									</tr>
									<tr>
								...
								<p style="text-align:center">
									<input type="image" src="${pageContext.request.contextPath }/client/images/botton_gif_025.gif" name="submit" border="0"/>
								</p>
