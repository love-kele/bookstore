...
<head>
	...
	<%--<script type="text/javascript" href="${pageContext.request.contextPath}/client/js/info.js"></script>--%>
</head>
									...
									<tr>
										<td width="30%">
											...
											<div style="text-align:center; margin-top:25px">
												<a href="${pageContext.request.contextPath}/addCart?id=${p.id}" id="addcar" onclick="cheacklogin()">
