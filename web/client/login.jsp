										...
										<td>
											<div id="logindiv">
												<table width="100%" border="0" cellspacing="0">
													...
													<tr>
														<td style="text-align:center;padding-top:20px;">
															<font	color="#ff0000">${error}</font>   <!-- 显示错误信息 -->
														</td>
													</tr>
													<tr>
															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	<td colspan="2" style="text-align:center">
																		...
																		记住用户名&nbsp;&nbsp; 
																		<input type="checkbox"
																		name="checkbox" value="checkbox" /> 自动登录
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	<td colspan="2" style="padding-top:10px">
																		<img
																		src="${pageContext.request.contextPath }/client/images/loginline.gif"
																		width="241" height="10" />
																	</td>
																</tr>
																 <%--<tr>--%>
										...
										<td style="text-align:left; padding-top:30px; width:60%">
											...
											<p style="text-align:left">
												<a href="${pageContext.request.contextPath }/client/register.jsp">
													<img
													src="${pageContext.request.contextPath }/client/images/signupbutton.gif"
													width="135" height="33" /> 
												</a>
											</p></td>
									</tr>
