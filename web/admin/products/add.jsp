	...
	<form id="userAction_save_do" name="Form1"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<input
					type="file" size="30" value="" onchange="selectImage(this);"/>
					<input type="button" onclick="uploadImage();" value="开始上传">
					<img src="${imgurl}" id="image" width="60px" height="40px"/>
					<input type="text" name="imgurl" hidden="hidden" value="${imgurl}" id="updatedurl"/>
				</td>
			</tr>
			<TR>
