							...
							<c:forEach items="${cars}" var="car">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="20%">${car.id}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%">${car.receiverName}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="15%">${car.receiverAddress }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%">${car.receiverPhone }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">
										${car.money}</td>
									<td width="8%" align="center">${car.user_id}</td>
									<td width="10%" align="center">${car.paystate==0?"未支付":"已支付"}</td>

									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/findOrderById?id=${car.id}&type=admin">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><c:if
											test="${car.paystate!=0 }">
											<a
												href="${pageContext.request.contextPath}/delOrderById?id=${car.id}&type=admin">
												<img
